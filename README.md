...
```
## Output Waveform
![image](https://github.com/user-attachments/assets/3a54458d-da2e-4a2d-95e7-40f7e093fe27)

## Results
Thus the FSK(Frequency shift keying) is performed using Python.

## Hardware experiment output waveform.
![image](https://github.com/user-attachments/assets/da448f62-f859-4304-8649-cbb52392fdb3)
